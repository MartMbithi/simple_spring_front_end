...
<head>
    ...
    <title> EduSite Log In | Spring Course Management System</title>
    ...
    <div class="container">
        ...
        <nav id="nav">
            <ul class="main-menu nav navbar-nav navbar-right">
                ...
                <li class="active"><a href="/spring3/login">Log In</a></li>
            </ul>
        </nav>
        <!-- /Navigation -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-10 col-md-offset-1 text-center">
                ...
                <h1 class="white-text">Log In To Learn | Enroll To A Course</h1>
            </div>
        </div>
    </div>
